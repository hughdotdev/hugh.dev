...
function createMagicLinkHtml(iconUrl: string, text: string, darkIconUrl?: string): string {
  if (darkIconUrl) {
...
export { parseMagicLinkContent, getDefaultIconUrl, extractDomain, createMagicLinkHtml };
